...
def main() -> None:
    ...
    with open(TXT_DIR / "group_assignments.txt", "w") as f:
        groups_dict = {}
    ...
    plot_by_group(
        ...
        "PolExpCapita",
        "Unweighted",
        "unweighted_polexpcapita_groups.png",
    )
    plot_by_group(
        df_unweighted,
        "PolExpCapita_yoy",
    ...
    plot_by_group(
        df_weighted, "AvgTaxRate", "Weighted", "weighted_avgtaxrate_groups.png"
    )
    plot_by_group(
        df_weighted,
        "AvgTaxRate_yoy",
        "Weighted YoY",
        "weighted_avgtaxrate_yoy_groups.png",
    )
    plot_by_group(
