...
with open(WD / "group_assignments_ppsa.txt", "w") as f:
    groups_dict = {}
...
plot_by_group(
    ...
    "PolExpShare",
    "PPSA: Unweighted",
    "unweighted_polexpshare_groups_ppsa.png",
)
plot_by_group(
    df_unweighted,
    "PolExpShare_yoy",
    "PPSA: Unweighted",
    "unweighted_polexpshare_yoy_groups_ppsa.png",
)
...
plot_by_group(
    ...
    "PolExpShare",
    "PPSA: Weighted",
    "weighted_polexpshare_groups_ppsa.png",
)
...
plot_by_group(
    ...
    "PolExpShare_yoy",
    "PPSA: Weighted",
    "weighted_polexpshare_yoy_groups_ppsa.png",
)
